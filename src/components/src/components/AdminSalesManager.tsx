...
import { ShoppingBag, Search, Calendar, DollarSign, Package, User, Eye, Download, Filter, TrendingUp, CheckCircle, Clock, X, AlertTriangle, RefreshCw, ChevronLeft, ChevronRight } from 'lucide-react';

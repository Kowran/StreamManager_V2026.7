...
import { ShoppingCart, Package, Star, DollarSign, Search, Check, AlertCircle, CreditCard, Loader, X, Truck, ArrowRight, ChevronLeft, ChevronRight, Eye, Image as ImageIcon, Store as StoreIcon, LayoutGrid, Clapperboard, Code, KeyRound, Music, Gamepad2, Shield, Gift, BookOpen, UserCheck, MessageCircle, type LucideIcon } from 'lucide-react';
...
export function Store() {
  ...
  async function handleConfirmPurchase(couponCode?: string) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t.store}</h2>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 text-sm font-bold whitespace-nowrap"
          >
          ...
          <button
            ...
            className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 px-6 py-3 group"
          >
  ...
  return (
    ...
    >
      ...
      <div className="p-3 lg:p-4">
        ...
        <h3 className="font-bold text-sm lg:text-base text-gray-900 dark:text-white mb-1 line-clamp-1">
          {product.name}
        </h3>
        ...
        <button
          ...
          className={`w-full px-3 py-2 rounded-xl transition-all flex items-center justify-center gap-1.5 text-sm font-semibold ${
...
function RechargeModal({ onClose, paymentMethods, onPaymentMethodSelect }: RechargeModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-6 border w-full max-w-2xl shadow-lg rounded-xl bg-white dark:bg-gray-800 max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            {paymentMethods.filter(m => m.enabled).map((method) => (
              <button
                ...
                className="w-full p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-900/10 transition-all group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center p-1 flex-shrink-0">
